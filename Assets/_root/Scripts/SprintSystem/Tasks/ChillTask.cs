...
namespace Scripts.Tasks
{
    public class ChillTask : IChillTask
    {
        ...
        public ChillTask(ProgressDataAdapter progressDataAdapter, string title, float progress)
        {
        ...
        public ITask Clone()
        {
           return new ChillTask(_progressDataAdapter, Title, Progress); 
        }
        ...
        public void ApplyProgress(float interval = 0f)
        {
            ...
            float delta = _progressDataAdapter.GetProgressData().Metadata.GetProgressDelta("Energy");
