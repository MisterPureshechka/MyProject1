...
{
    public class PrototypeState : BaseState
    {
        public PrototypeState(GameStateMachine gameStateMachine, Controllers controllers, GameProgress gameProgress, GameData gameData) : base(gameStateMachine, controllers, gameProgress, gameData)
        {
        }
        ...
        public override void Enter()
        {
            ...
            Debug.LogError("Prototype entered");
